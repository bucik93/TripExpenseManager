...
namespace TripExpenseManager.Data
{
    ...
    {
        private const string DbName = "TripexManger.db3";
        ...
        public async Task<TTable> FindAsync<TTable>(object primaryKey) where TTable : class, new() => await Execute<TTable, TTable>(async () => await Database.FindAsync<TTable>(primaryKey));
